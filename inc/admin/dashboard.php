...
?>
			<div class="customify-notice-wrapper notice is-dismissible">
				<div class="customify-notice">
					<div class="customify-notice-img">
						<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/admin/uxnitro-logo-admin.svg'); ?>" alt="<?php esc_attr_e('logo', 'uxnitro'); ?>">
					</div>
					<div class="customify-notice-content">
						<div class="customify-notice-heading"><?php _e('Thanks for installing UXNitro, you rock! <img draggable="false" class="emoji" alt="" src="https://s.w.org/images/core/emoji/2.4/svg/1f918.svg">', 'uxnitro'); ?></div>
						<p><?php printf(__('To fully take advantage of the best our theme can offer please make sure you visit our <a href="%1$s">UXNitro</a> page.', 'uxnitro'), esc_url(admin_url('themes.php?page=customify'))); ?></p>
						<?php if (is_child_theme()) { ?>
							<?php $child_theme = wp_get_theme(); ?>
							<?php printf(esc_html__('You\'re using %1$s theme, It\'s a child theme of %2$s.', 'uxnitro'), '<strong>' . $child_theme->Name . '</strong>', '<strong>' . esc_html__('UXNitro', 'uxnitro') . '</strong>'); // phpcs:ignore
							?>
							<?php
							...
							?>
							<?php printf('%s <a href="%s" class="go-to-setting">%s</a>', esc_html__('Now you can copy setting data from parent theme to this child theme', 'uxnitro'), esc_url($copy_link), esc_html__('Copy Settings', 'uxnitro')); ?>
						<?php } ?>
					</div>
				</div>
			</div>
	...
	function add_menu()
	{
		self::$_instance->title = __('UXNitro', 'uxnitro');
		add_theme_page(
			$this->title,
			$this->title,
			'manage_options',
		...
		<div class="cd-header">
			<div class="cd-row">
				<div class="cd-header-inner">
					<a href="https://uxnitro.com" target="_blank" class="cd-branding">
						<img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/admin/uxnitro-logo-admin.svg'; ?>" alt="<?php esc_attr_e('logo', 'uxnitro'); ?>">
					</a>
					<span class="cd-version"><?php echo esc_html($this->config['version']); ?></span>
					<a class="cd-top-link" href="<?php echo esc_url($this->add_url_args(array('tab' => 'changelog'))); ?>"><?php _e('Changelog', 'uxnitro'); ?></a>
				</div>
			</div>
		</div>
	<?php
			...
			<div class="cd-box copy-theme-settings">
				...
				<div class="cd-box-content">
					<form method="post" action="<?php echo esc_attr($current_action_link); ?>" class="demo-import-boxed copy-settings-form">
						...
						<p>
							<strong> <?php printf(esc_html__('You\'re using %1$s theme, It\'s a child theme of UXNitro', 'customify'), $child_theme->Name); // phpcs:ignore
												?></strong>
						</p>
						...
						<div class="form-fields">
							<div class="select-theme-fields">
								...
								$select .= '<option value="uxnitro">UXNitro</option>';
								...
								$select_2 .= '<option value="uxnitro">UXNitro</option>';
	...
	?>
		<div class="cd-box">
			<div class="cd-box-top"><?php _e('Join the Community!', 'uxnitro'); ?></div>
			<div class="cd-box-content">
				<p><?php _e('Connect with UXNitro across platforms:', 'uxnitro'); ?></p>
				<ul class="cd-community-links">
					<li>
						<a target="_blank" href="https://github.com/uxnitro">
							<span class="dashicons dashicons-code"></span>
							<?php _e('GitHub', 'uxnitro'); ?> ↗
						</a>
					</li>
					<li>
						<a target="_blank" href="https://www.trustpilot.com/review/uxnitro.com">
							<span class="dashicons dashicons-star-filled"></span>
							<?php _e('Trustpilot Reviews', 'uxnitro'); ?> ↗
						</a>
					</li>
					<li>
						<a target="_blank" href="https://www.youtube.com/@uxnitro">
							<span class="dashicons dashicons-video-alt3"></span>
							<?php _e('YouTube Channel', 'uxnitro'); ?> ↗
						</a>
					</li>
				</ul>
			</div>
		...
		<style>
			...
			.cd-community-links li {
				margin-bottom: 8px;
			}
			.cd-community-links a {
				display: inline-flex;
				align-items: center;
				gap: 5px;
			...
			.cd-community-links a:hover {
				text-decoration: underline;
			}
			.cd-community-links .dashicons {
				width: 18px;
				height: 18px;
				font-size: 18px;
			}
	...
	?>
		<div class="cd-box box-plugins">
			<div class="cd-box-top"><?php _e('UXNitro ready to import sites', 'customify'); ?></div>
			<div class="cd-sites-thumb">
				<img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/admin/sites_thumbnail.jpg'; ?>">
			</div>
			<div class="cd-box-content">
				<p><?php _e('<strong>UXNitro Sites</strong> is a free add-on for the UXNitro theme which help you browse and import ready made websites with few clicks.', 'customify'); ?></p>
				<?php
				...
				if (!is_plugin_active($active_file_name)) {
					...
					if (!$status) {
						...
						$install_url = 'https://github.com/UXNitro/uxnitro-sites-library/releases/';
					} else {
					...
					$detail_link = 'https://github.com/UXNitro/uxnitro-sites-library';
